...
public class ServerStartupListener extends BroadcastReceiver {
    public static final String HSC_SERVER_STARTED = "com.rudyii.hsw.client.HSC_SERVER_STARTED";

    @Override
    public void onReceive(Context context, Intent intent) {
        @SuppressWarnings("unchecked") HashMap<String, Object> startupData = (HashMap<String, Object>) intent.getSerializableExtra("HSC_SERVER_STARTED");
